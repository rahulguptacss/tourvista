          ...
          >
            <motion.div variants={fadeInLeft} className="max-w-xl">
              ...
              <h2 className="text-[30px] md:text-[44px] font-bold leading-[1.2] text-white">
                ...
                <span className={`text-[#ff7a00] font-normal ${kaushan.className}`}>{ctaBanner.titleHighlight}</span>
              </h2>
            </motion.div>

            <motion.div variants={fadeInRight} className="mt-2 md:mt-0">
              <Link
                href={ctaBanner.buttonHref || "/contact"}
                className="inline-flex shrink-0 items-center gap-3 rounded-full bg-[#ff7a00] pl-6 pr-2 py-1.5 md:py-2 text-[15px] md:text-[16.5px] font-semibold text-white shadow-[0_10px_24px_rgba(255,122,0,0.3)] transition-transform hover:scale-[1.03]"
              >
