...
import type { TeamDetailViewData, TeamSocial } from "../../types";
...
export default function TeamDetail({ data }: { data: TeamDetailViewData }) {
  if (!data) return null;
        ...
        >
          ...
          <motion.div variants={fadeInRight} className="w-full md:w-[60%] lg:w-[68%] flex flex-col">
            ...
            <div className="flex items-center gap-3">
              {data.member.socials?.map((social: TeamSocial, idx: number) => {
